...
String _html_str = "";
 //BA.debugLineNum = 16;BA.debugLine="Sub qrCodeFromHtml(html As String) As Int";
 //BA.debugLineNum = 17;BA.debugLine="Dim return_int As Int = -1";
_return_int = (int) (-1);
 //BA.debugLineNum = 18;BA.debugLine="Dim str_start_int As Int = 0";
_str_start_int = (int) (0);
 //BA.debugLineNum = 19;BA.debugLine="Dim str_end_int As Int = 0";
_str_end_int = (int) (0);
 //BA.debugLineNum = 20;BA.debugLine="Dim return_qrcode As Int = 0";
_return_qrcode = (int) (0);
 //BA.debugLineNum = 21;BA.debugLine="Dim html_str As String = \"\"";
_html_str = "";
 //BA.debugLineNum = 23;BA.debugLine="If html <> \"\" And html.Length() > 0 Then";
if ((_html).equals("") == false && _html.length()>0) { 
 //BA.debugLineNum = 24;BA.debugLine="str_start_int = html.IndexOf(\"weixin\")";
_str_start_int = _html.indexOf("weixin");
 //BA.debugLineNum = 25;BA.debugLine="If str_start_int > 0 And str_start_int < html.Le";
if (_str_start_int>0 && _str_start_int<_html.length()) { 
 //BA.debugLineNum = 26;BA.debugLine="html_str = html.SubString2(str_start_int,html.L";
_html_str = _html.substring(_str_start_int,_html.length());
 };
 //BA.debugLineNum = 28;BA.debugLine="str_end_int = html_str.IndexOf(\"<\")";
_str_end_int = _html_str.indexOf("<");
 //BA.debugLineNum = 29;BA.debugLine="If str_end_int > 0 Then";
if (_str_end_int>0) { 
 //BA.debugLineNum = 30;BA.debugLine="html_str = html_str.SubString2(0,str_end_int)";
_html_str = _html_str.substring((int) (0),_str_end_int);
 };
 };
 //BA.debugLineNum = 35;BA.debugLine="return_qrcode = alipay.QRCODE.returnSucOrFail(htm";
_return_qrcode = mostCurrent._alipay._qrcode.returnSucOrFail(_html_str,mostCurrent._alipay._photo_path,_qr_name_weixin,mostCurrent._alipay._qrcode_width_height);
 //BA.debugLineNum = 38;BA.debugLine="If return_qrcode == 1 Then";
if (_return_qrcode==1) { 
 //BA.debugLineNum = 39;BA.debugLine="If alipay.logoIntoQrCode(WEIXIN_LOGO_NAME, QR_NA";
if (mostCurrent._alipay._logointoqrcode(_ba,_weixin_logo_name,_qr_name_weixin,_weixin_logo_qrcode_name)==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 40;BA.debugLine="return_int = 1";
_return_int = (int) (1);
 };
 };
 //BA.debugLineNum = 43;BA.debugLine="Return return_int";
