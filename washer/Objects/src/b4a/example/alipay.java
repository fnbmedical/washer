...
public static String _str_pay_success = "";
public static String _str_qrcode_index = "";
public static String _str_qrcode_last = "";
public static String _show_url = "";
public static String _payment_type = "";
public static String _notify_url = "";
public static String _return_url = "";
public static String _anti_phishing_key = "";
public static String _exter_invoke_ip = "";
public static String _str_money = "";
...
anywheresoftware.b4a.objects.collections.Map _mapali = null;
 //BA.debugLineNum = 70;BA.debugLine="Sub aliQrCode(order_num As String,order_price As I";
 //BA.debugLineNum = 71;BA.debugLine="Dim return_str As String = \"\"";
_return_str = "";
 //BA.debugLineNum = 74;BA.debugLine="Dim out_trade_no As String = order_num";
_out_trade_no = _order_num;
 //BA.debugLineNum = 76;BA.debugLine="Dim subject As String = ORDERNAME";
_subject = _ordername;
 //BA.debugLineNum = 78;BA.debugLine="Dim body As String = ORDERDESC&order_desc";
_body = _orderdesc+_order_desc;
 //BA.debugLineNum = 80;BA.debugLine="str_Money = (order_price * 0.01)&\"\"";
_str_money = BA.NumberToString((_order_price*0.01))+"";
 //BA.debugLineNum = 82;BA.debugLine="Dim mapali As Map";
_mapali = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 84;BA.debugLine="mapali.Initialize()";
_mapali.Initialize();
 //BA.debugLineNum = 86;BA.debugLine="mapali.Put(\"service\",\"create_direct_pay_by_user\")";
_mapali.Put((Object)("service"),(Object)("create_direct_pay_by_user"));
 //BA.debugLineNum = 87;BA.debugLine="mapali.Put(\"partner\", alipayConfig.partner)";
_mapali.Put((Object)("partner"),(Object)(_alipayconfig.partner));
 //BA.debugLineNum = 88;BA.debugLine="mapali.put(\"seller_email\", alipayConfig.seller_em";
_mapali.Put((Object)("seller_email"),(Object)(_alipayconfig.seller_email));
 //BA.debugLineNum = 89;BA.debugLine="mapali.put(\"_input_charset\", alipayConfig.input_c";
_mapali.Put((Object)("_input_charset"),(Object)(_alipayconfig.input_charset));
 //BA.debugLineNum = 90;BA.debugLine="mapali.put(\"payment_type\", payment_type)";
_mapali.Put((Object)("payment_type"),(Object)(_payment_type));
 //BA.debugLineNum = 91;BA.debugLine="mapali.put(\"notify_url\", notify_url)";
_mapali.Put((Object)("notify_url"),(Object)(_notify_url));
 //BA.debugLineNum = 92;BA.debugLine="mapali.put(\"return_url\", return_url)";
_mapali.Put((Object)("return_url"),(Object)(_return_url));
 //BA.debugLineNum = 93;BA.debugLine="mapali.put(\"out_trade_no\", out_trade_no)";
_mapali.Put((Object)("out_trade_no"),(Object)(_out_trade_no));
 //BA.debugLineNum = 94;BA.debugLine="mapali.put(\"subject\", subject)";
_mapali.Put((Object)("subject"),(Object)(_subject));
 //BA.debugLineNum = 95;BA.debugLine="mapali.put(\"total_fee\", str_Money)";
_mapali.Put((Object)("total_fee"),(Object)(_str_money));
 //BA.debugLineNum = 96;BA.debugLine="mapali.put(\"body\", body)";
_mapali.Put((Object)("body"),(Object)(_body));
 //BA.debugLineNum = 97;BA.debugLine="mapali.put(\"show_url\", show_url)";
_mapali.Put((Object)("show_url"),(Object)(_show_url));
 //BA.debugLineNum = 98;BA.debugLine="mapali.put(\"anti_phishing_key\", anti_phishing_key";
_mapali.Put((Object)("anti_phishing_key"),(Object)(_anti_phishing_key));
 //BA.debugLineNum = 99;BA.debugLine="mapali.put(\"exter_invoke_ip\", exter_invoke_ip)";
_mapali.Put((Object)("exter_invoke_ip"),(Object)(_exter_invoke_ip));
 //BA.debugLineNum = 100;BA.debugLine="return_str = createHtml(alipaySubmit.buildRequest";
_return_str = _createhtml(_ba,_alipaysubmit.buildRequest((java.util.Map)(_mapali.getObject()),"get","确认"));
 //BA.debugLineNum = 102;BA.debugLine="Return return_str";
...
anywheresoftware.b4a.keywords.StringBuilderWrapper _strbuilder = null;
 //BA.debugLineNum = 118;BA.debugLine="Sub createHtml(str As String) As String";
 //BA.debugLineNum = 119;BA.debugLine="Dim strBuilder As StringBuilder";
_strbuilder = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 121;BA.debugLine="strBuilder.Initialize()";
_strbuilder.Initialize();
 //BA.debugLineNum = 123;BA.debugLine="strBuilder.Append(\"<html>\").Append(\"<head>\")";
_strbuilder.Append("<html>").Append("<head>");
 //BA.debugLineNum = 124;BA.debugLine="strBuilder.Append($\"<meta http-equiv=\"Content-Typ";
_strbuilder.Append(("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />"));
 //BA.debugLineNum = 125;BA.debugLine="strBuilder.Append(\"</head>\").Append(\"<body>\").App";
_strbuilder.Append("</head>").Append("<body>").Append(_str).Append("</body>").Append("</html>");
 //BA.debugLineNum = 127;BA.debugLine="Return strBuilder.ToString()";
...
int _return_qrcode = 0;
 //BA.debugLineNum = 131;BA.debugLine="Sub getQrCodeFromHtml(html As String) As Int";
 //BA.debugLineNum = 132;BA.debugLine="Dim returnInt As Int = -1";
_returnint = (int) (-1);
 //BA.debugLineNum = 133;BA.debugLine="Dim html_str As String = \"\"";
_html_str = "";
 //BA.debugLineNum = 134;BA.debugLine="Dim searchCode_index_int As Int = -1";
_searchcode_index_int = (int) (-1);
 //BA.debugLineNum = 135;BA.debugLine="Dim searchCode_last_int As Int = -1";
_searchcode_last_int = (int) (-1);
 //BA.debugLineNum = 137;BA.debugLine="html = html.Trim()";
_html = _html.trim();
 //BA.debugLineNum = 138;BA.debugLine="If (html <> \"\" And html.Length() > 0) Then";
if (((_html).equals("") == false && _html.length()>0)) { 
 //BA.debugLineNum = 139;BA.debugLine="searchCode_index_int = html.IndexOf(str_qrcode_i";
_searchcode_index_int = _html.indexOf(_str_qrcode_index);
 //BA.debugLineNum = 140;BA.debugLine="searchCode_last_int = html.LastIndexOf(str_qrcod";
_searchcode_last_int = _html.lastIndexOf(_str_qrcode_last);
 };
 //BA.debugLineNum = 143;BA.debugLine="If searchCode_index_int >= 0 And searchCode_last_";
if (_searchcode_index_int>=0 && _searchcode_last_int>=0 && _searchcode_index_int<_searchcode_last_int) { 
 //BA.debugLineNum = 144;BA.debugLine="html_str = html.SubString2(searchCode_index_int,";
_html_str = _html.substring(_searchcode_index_int,_searchcode_last_int);
 };
 //BA.debugLineNum = 147;BA.debugLine="If html_str <> \"\" And html_str.Length() > 0 Then";
if ((_html_str).equals("") == false && _html_str.length()>0) { 
 //BA.debugLineNum = 148;BA.debugLine="html_str = getStringFrom(html_str)";
_html_str = _getstringfrom(_ba,_html_str);
 //BA.debugLineNum = 149;BA.debugLine="If html_str <> \"\" And html_str.Length() > 0 Then";
if ((_html_str).equals("") == false && _html_str.length()>0) { 
 //BA.debugLineNum = 150;BA.debugLine="Dim return_qrcode As Int = 0";
_return_qrcode = (int) (0);
 //BA.debugLineNum = 152;BA.debugLine="return_qrcode = QRCODE.returnSucOrFail(html_str";
_return_qrcode = _qrcode.returnSucOrFail(_html_str,_photo_path,_qr_name,_qrcode_width_height);
 //BA.debugLineNum = 153;BA.debugLine="Log(return_qrcode)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_return_qrcode));
 //BA.debugLineNum = 154;BA.debugLine="If return_qrcode == 1 Then";
if (_return_qrcode==1) { 
 //BA.debugLineNum = 155;BA.debugLine="If logoIntoQrCode(ALI_LOGO_NAME, QR_NAME, QR_C";
if (_logointoqrcode(_ba,_ali_logo_name,_qr_name,_qr_code_logo)==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 156;BA.debugLine="returnInt = 1";
_returnint = (int) (1);
 };
 };
 };
 };
 //BA.debugLineNum = 161;BA.debugLine="Return returnInt";
...
String _return_str = "";
int _search_int = 0;
 //BA.debugLineNum = 182;BA.debugLine="Sub getStringFrom(html_str As String) As String";
 //BA.debugLineNum = 183;BA.debugLine="Dim return_str As String = \"\"";
_return_str = "";
 //BA.debugLineNum = 184;BA.debugLine="Dim search_int As Int = -1";
_search_int = (int) (-1);
 //BA.debugLineNum = 185;BA.debugLine="If html_str <> \"\" And html_str.Length() > 0 Then";
if ((_html_str).equals("") == false && _html_str.length()>0) { 
 //BA.debugLineNum = 186;BA.debugLine="search_int = html_str.LastIndexOf(\"=\")";
_search_int = _html_str.lastIndexOf("=");
 };
 //BA.debugLineNum = 188;BA.debugLine="If search_int >= 0 And search_int + 1 < html_str.";
if (_search_int>=0 && _search_int+1<_html_str.length()) { 
 //BA.debugLineNum = 189;BA.debugLine="return_str = html_str.SubString(search_int+1)";
_return_str = _html_str.substring((int) (_search_int+1));
 };
 //BA.debugLineNum = 191;BA.debugLine="If return_str <> \"\" And return_str.Length() > 0 T";
if ((_return_str).equals("") == false && _return_str.length()>0) { 
 //BA.debugLineNum = 192;BA.debugLine="return_str = return_str.Replace($\"\"\"$,\"\")";
_return_str = _return_str.replace(("\""),"");
 };
 //BA.debugLineNum = 194;BA.debugLine="Return return_str";
if (true) return _return_str;
...
int _assert_int = 0;
 //BA.debugLineNum = 165;BA.debugLine="Sub getSuccessFromHtml(html As String) As Int";
 //BA.debugLineNum = 166;BA.debugLine="Dim assert_int As Int = -1";
_assert_int = (int) (-1);
 //BA.debugLineNum = 168;BA.debugLine="If (html<>\"\" And html.Length() > 0) Then";
if (((_html).equals("") == false && _html.length()>0)) { 
 //BA.debugLineNum = 169;BA.debugLine="assert_int = html.Trim().IndexOf(str_pay_success";
_assert_int = _html.trim().indexOf(_str_pay_success);
 };
 //BA.debugLineNum = 174;BA.debugLine="If assert_int <> -1 Then";
if (_assert_int!=-1) { 
 };
 //BA.debugLineNum = 178;BA.debugLine="Return assert_int";
...
int _rct_width = 0;
int _rct_hight = 0;
 //BA.debugLineNum = 201;BA.debugLine="Sub logoIntoQrCode(logoName As String,qrCodeName A";
 //BA.debugLineNum = 202;BA.debugLine="Dim bmp_logo As Bitmap";
_bmp_logo = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 203;BA.debugLine="Dim bmp_qrCode As Bitmap";
_bmp_qrcode = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 204;BA.debugLine="Dim return_Flag As Boolean = False";
_return_flag = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 206;BA.debugLine="Dim bmp_Mut As Bitmap";
...
_cvs = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 208;BA.debugLine="Dim out As OutputStream";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 209;BA.debugLine="If File.Exists(PHOTO_PATH,qrCodeName) == False Th";
if (anywheresoftware.b4a.keywords.Common.File.Exists(_photo_path,_qrcodename)==anywheresoftware.b4a.keywords.Common.False) { 
 };
 //BA.debugLineNum = 212;BA.debugLine="If File.Exists(PHOTO_PATH,logoName) And File.Exis";
if (anywheresoftware.b4a.keywords.Common.File.Exists(_photo_path,_logoname) && anywheresoftware.b4a.keywords.Common.File.Exists(_photo_path,_qrcodename)) { 
 //BA.debugLineNum = 213;BA.debugLine="bmp_logo.Initialize(PHOTO_PATH,logoName)";
_bmp_logo.Initialize(_photo_path,_logoname);
 //BA.debugLineNum = 214;BA.debugLine="bmp_qrCode.Initialize(PHOTO_PATH,qrCodeName)";
_bmp_qrcode.Initialize(_photo_path,_qrcodename);
 //BA.debugLineNum = 216;BA.debugLine="bmp_Mut.InitializeMutable(bmp_qrCode.Width,bmp_q";
_bmp_mut.InitializeMutable(_bmp_qrcode.getWidth(),_bmp_qrcode.getHeight());
 //BA.debugLineNum = 218;BA.debugLine="cvs.Initialize2(bmp_Mut)";
_cvs.Initialize2((android.graphics.Bitmap)(_bmp_mut.getObject()));
 //BA.debugLineNum = 219;BA.debugLine="Dim r As Rect";
_r = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 220;BA.debugLine="r.Initialize(0,0,bmp_qrCode.Width,bmp_qrCode.Hei";
_r.Initialize((int) (0),(int) (0),_bmp_qrcode.getWidth(),_bmp_qrcode.getHeight());
 //BA.debugLineNum = 221;BA.debugLine="cvs.DrawRect(r,Colors.White,True,0)";
_cvs.DrawRect((android.graphics.Rect)(_r.getObject()),anywheresoftware.b4a.keywords.Common.Colors.White,anywheresoftware.b4a.keywords.Common.True,(float) (0));
 //BA.debugLineNum = 223;BA.debugLine="Dim rt As Rect";
_rt = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 224;BA.debugLine="rt.Initialize(0,0,cvs.Bitmap.Width,cvs.Bitmap.He";
_rt.Initialize((int) (0),(int) (0),_cvs.getBitmap().getWidth(),_cvs.getBitmap().getHeight());
 //BA.debugLineNum = 225;BA.debugLine="cvs.DrawBitmap(bmp_qrCode,Null,rt)";
_cvs.DrawBitmap((android.graphics.Bitmap)(_bmp_qrcode.getObject()),(android.graphics.Rect)(anywheresoftware.b4a.keywords.Common.Null),(android.graphics.Rect)(_rt.getObject()));
 //BA.debugLineNum = 226;BA.debugLine="Dim rct As Rect";
_rct = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 227;BA.debugLine="Dim bmp_logo_width As Int = bmp_logo.Width";
_bmp_logo_width = _bmp_logo.getWidth();
 //BA.debugLineNum = 228;BA.debugLine="Dim bmp_logo_height As Int = bmp_logo.Height";
_bmp_logo_height = _bmp_logo.getHeight();
 //BA.debugLineNum = 229;BA.debugLine="If bmp_logo_width > LOGO_WIDTH Then";
if (_bmp_logo_width>_logo_width) { 
 //BA.debugLineNum = 230;BA.debugLine="bmp_logo_width = LOGO_WIDTH";
_bmp_logo_width = _logo_width;
 };
 //BA.debugLineNum = 232;BA.debugLine="If bmp_logo_height > LOGO_HEIGHT Then";
if (_bmp_logo_height>_logo_height) { 
 //BA.debugLineNum = 233;BA.debugLine="bmp_logo_height = LOGO_HEIGHT";
_bmp_logo_height = _logo_height;
 };
 //BA.debugLineNum = 235;BA.debugLine="Dim rct_top As Int = (cvs.Bitmap.Width - bmp_log";
_rct_top = (int) ((_cvs.getBitmap().getWidth()-_bmp_logo_width)/(double)2);
 //BA.debugLineNum = 236;BA.debugLine="Dim rct_bottom As Int = (cvs.Bitmap.Height - bmp";
_rct_bottom = (int) ((_cvs.getBitmap().getHeight()-_bmp_logo_height)/(double)2);
 //BA.debugLineNum = 237;BA.debugLine="Dim rct_width As Int = (cvs.Bitmap.Width + bmp_l";
_rct_width = (int) ((_cvs.getBitmap().getWidth()+_bmp_logo_width)/(double)2);
 //BA.debugLineNum = 238;BA.debugLine="Dim rct_hight As Int = (cvs.Bitmap.Height + bmp_";
_rct_hight = (int) ((_cvs.getBitmap().getHeight()+_bmp_logo_height)/(double)2);
 //BA.debugLineNum = 239;BA.debugLine="rct.Initialize(rct_top,rct_bottom,rct_width,rct_";
_rct.Initialize(_rct_top,_rct_bottom,_rct_width,_rct_hight);
 //BA.debugLineNum = 242;BA.debugLine="cvs.DrawBitmap(bmp_logo,Null,rct)";
_cvs.DrawBitmap((android.graphics.Bitmap)(_bmp_logo.getObject()),(android.graphics.Rect)(anywheresoftware.b4a.keywords.Common.Null),(android.graphics.Rect)(_rct.getObject()));
 //BA.debugLineNum = 243;BA.debugLine="out = File.OpenOutput(PHOTO_PATH,qrCodeWithLogo,";
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(_photo_path,_qrcodewithlogo,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 244;BA.debugLine="cvs.Bitmap.WriteToStream(out,100,\"PNG\")";
...
_out.Close();
 //BA.debugLineNum = 246;BA.debugLine="return_Flag = True";
_return_flag = anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 248;BA.debugLine="Return return_Flag";
...
_qrcode = new com.zyg.jni.QrCodeJNI();
 //BA.debugLineNum = 44;BA.debugLine="Dim MY_LOGO_NAME As String = \"my_logo.png\"";
_my_logo_name = "my_logo.png";
 //BA.debugLineNum = 47;BA.debugLine="Dim str_pay_success As String = \"验证成功\"";
_str_pay_success = "验证成功";
 //BA.debugLineNum = 50;BA.debugLine="Dim str_qrcode_index As String = $\"name=\"qrCode\"\"";
_str_qrcode_index = ("name=\"qrCode\"");
 //BA.debugLineNum = 51;BA.debugLine="Dim str_qrcode_last As String = $\"id=\"J_qrCode\"\"$";
_str_qrcode_last = ("id=\"J_qrCode\"");
 //BA.debugLineNum = 54;BA.debugLine="Dim show_url As String = \"http://www.k91d.com/pro";
_show_url = "http://www.k91d.com/pro.htm";
 //BA.debugLineNum = 57;BA.debugLine="Dim payment_type As String = \"1\"";
_payment_type = "1";
 //BA.debugLineNum = 59;BA.debugLine="Dim notify_url As String = \"http://www.k91d.com/p";
_notify_url = "http://www.k91d.com/pay/notify_url.php";
 //BA.debugLineNum = 61;BA.debugLine="Dim return_url As String = \"http://www.k91d.com/p";
_return_url = "http://www.k91d.com/pay/return_url.php";
 //BA.debugLineNum = 63;BA.debugLine="Dim anti_phishing_key As String = \"\"";
_anti_phishing_key = "";
 //BA.debugLineNum = 65;BA.debugLine="Dim exter_invoke_ip As String = \"\"";
_exter_invoke_ip = "";
 //BA.debugLineNum = 67;BA.debugLine="Dim str_Money As String = \"\"";
_str_money = "";
...
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(_photo_path,_logo_name,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 112;BA.debugLine="bmp.WriteToStream(out,100,\"PNG\")";
_bmp.WriteToStream((java.io.OutputStream)(_out.getObject()),(int) (100),BA.getEnumFromString(android.graphics.Bitmap.CompressFormat.class,"PNG"));
 //BA.debugLineNum = 113;BA.debugLine="out.Close";
_out.Close();
 };
